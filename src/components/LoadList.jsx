...
const Row = ({ index, load, toggleEnabled, handleEditRow, deleteLoad, editingRowId, editedRow, handleInputChange, handleSaveRow, handleCancelEdit }) => {
  return (
    <div className="overflow-x-auto">
      <div className="grid min-w-[1000px] grid-cols-7 gap-2 items-center p-2">
        {/* Column 1: Checkbox */}
    ...
    <div className="bg-white rounded shadow p-4 mb-6">
      ...
      {loads.length === 0 ? (
        ...
        <>
          {/* Header Row */}
          <div className="overflow-x-auto">
            <div className="grid min-w-[1000px] grid-cols-7 gap-2 font-semibold text-sm bg-gray-100 p-2 border-b">
